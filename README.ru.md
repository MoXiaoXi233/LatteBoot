...
* Поддерживается Dual Boot *(Android + Windows)*, пункты меню скрываются или отображаются в зависимости от наличия нужного загрузочного файла
* Поддерживается распознавание запуска следующей системы *(С версии v1.5)*
